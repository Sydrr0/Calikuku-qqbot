...
def all_sell_data():
    ...
    try:
        ...
        price_changing_num = tree.xpath('/html/body/div/div[4]/div/div[1]/div/div[1]/div[4]/div[1]/div[3]/text()')[
                                 1] + '%'
    except:
    ...
    try:
        ...
        count_changing_num = tree.xpath('/html/body/div[1]/div[4]/div/div[1]/div/div[1]/div[4]/div[2]/div[3]/text()')[
                                 1] + '%'
    except:
