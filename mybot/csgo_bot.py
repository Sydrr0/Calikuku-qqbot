...
import all_sell,missing,mini_price_get
#bot基础设置
cqLog(logging.INFO)
cqapi = cqHttpApi()
...
#没有用的小程序
'''
def wea(commandData, message: Message):
    message.reply("%s\n--------------------------\n以上数据来源于中国气象网\n由沙先涛爬取"%(weather.final) )
csgo_bot.command(wea, "天气", {"type": "all"})
'''
